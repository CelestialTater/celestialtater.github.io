...
async function startGame(){
    ...
    myGameArea.start()
    icon = new component(30, 30, "http://127.0.0.1:5500/JS%20game/electron.png", 10, 190, "image");
    photon1 = new component(30, 30, "http://127.0.0.1:5500/JS%20game/photonwave.png", p1X, p1Y, "image", 3);
    photon2 = new component(30, 30, "http://127.0.0.1:5500/JS%20game/photonwave.png", p2X, p2Y, "image", 4);
    photon3 = new component(30, 30, "http://127.0.0.1:5500/JS%20game/photonwave.png", p3X, p3Y, "image", 5);
    photonCoords = [
        [p1X, p1Y, photon1],
        [p2X, p2Y, photon2],
        [p3X, p3Y, photon3]
